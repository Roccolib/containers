...
#     producer = KafkaProducer(value_serializer=lambda v: json.dumps(v).encode('utf-8'), bootstrap_servers='localhost:29092', request_timeout_ms=1)
     attente = producer.send(topicName, data)
     result = attente.get #(timeout=0.9)
     producer.flush()
#     print (data)
